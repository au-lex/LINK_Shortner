...
const Head = () => {
  ...
  const toggleMenu = () => {
    ...
    return (
        ...
        <section className="imgContainer lg:flex    lg:justify-between lg:mt-24 ">
            <figure className=" overflow-hidden mt-6 lg:hidden">
          <div className="w-[500px] h-[300p] pl-10 ">
