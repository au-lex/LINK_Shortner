...
const Hero = () => {
    ...
    return (
     ...
     <section className="cardComp flex justify-center  px-5 flex-col lg:flex-row  mt-[8rem] lg:px-60 xl:px-20">
        <div className="cardcontainer   bg-white w-full h-[20rem] rounded-xl relative my-[2rem] lg:mx-[2rem] xl:w-[100rem] ">
        ...
        <div className="cardcontainer   bg-white w-full h-[20rem] rounded-xl relative my-[4rem] lg:mx-[2rem] lg:mt-20  xl:w-[100rem]">
        <div className="cardLogo   bg-bg rounded-full w-[8rem] absolute h-[8rem]
         left-[6.7rem] top-[-4rem] px-11 py-10
        ...
        <div className="cardcontainer   bg-white w-full h-[20rem] rounded-xl relative my-[4rem] xl:w-[100rem]
         lg:mx-[2rem] lg:mt-32 ">
        <div className="cardLogo   bg-bg rounded-full w-[8rem] absolute h-[8rem]
         left-[6.7rem] top-[-4rem] px-11 py-10
